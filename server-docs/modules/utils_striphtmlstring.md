[did-server](../README.md) / utils/stripHtmlString
...
Defined in: [server/utils/stripHtmlString.ts:10](https://github.com/Puzzlepart/did/blob/4fe732f3/server/utils/stripHtmlString.ts#L10)
