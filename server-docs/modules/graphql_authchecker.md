[did-server - v0.10.0](../README.md) / graphql/authChecker
...
Defined in: [server/graphql/authChecker.ts:23](https://github.com/Puzzlepart/did/blob/dev/server/graphql/authChecker.ts#L23)
