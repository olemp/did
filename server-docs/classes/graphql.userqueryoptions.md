[did-server](../README.md) / [graphql](../modules/graphql.md) / UserQueryOptions
...
Defined in: [server/graphql/resolvers/user/types.ts:88](https://github.com/Puzzlepart/did/blob/45604452/server/graphql/resolvers/user/types.ts#L88)
