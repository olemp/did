[did-client - v0.10.0](../README.md) / [Components](../modules/components.md) / ProjectFilter
...
Defined in: [client/components/FilterPanel/Filters/ProjectFilter.ts:40](https://github.com/Puzzlepart/did/blob/dev/client/components/FilterPanel/Filters/ProjectFilter.ts#L40)
