[did-server - v0.9.11](../README.md) / graphql/authChecker
...
Defined in: [server/graphql/authChecker.ts:24](https://github.com/Puzzlepart/did/blob/dev/server/graphql/authChecker.ts#L24)
