...
module.exports = async (_obj, args, context) => {
    ...
    const filter1 = TableQuery.int32Filter('WeekNumber', TableUtilities.QueryComparisons.EQUAL, args.weekNumber);
    const filter2 = TableQuery.stringFilter('ResourceId', TableUtilities.QueryComparisons.EQUAL, context.user.profile.oid);
    const combinedFilters = TableQuery.combineFilters(filter1, TableUtilities.TableOperators.AND, filter2);
