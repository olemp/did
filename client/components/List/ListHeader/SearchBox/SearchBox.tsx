...
export const SearchBoxComponent: StyledComponent<IListProps['searchBox']> = (props) => {
    const context = useListContext()
    const searchDelay = useRef(null)
    return (
        <SearchBox
            {..._.omit(props, 'placeholder', 'fullWidth')}
            className={css(SearchBoxComponent.className, props.fullWidth && styles.fullWidth)}
            placeholder={
