 ...
 * @category Projects
 */
export function useProjectTimeEntriesSummary(
  props: IProjectTimeEntriesSummaryProps
) {
  const { t } = useTranslation()
  const enableInvoiceEstimation = useSubscriptionSettings<boolean>(
    'projects.enableInvoiceEstimation',
    false
  )
