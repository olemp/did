...
export const SuggestedProjectMessage: StyledComponent<ISuggestedProjectMessageProps> = ({ eventId, project: suggestedProject }) => {
                    ...
                    components={{
                        Link: (
                            <a
                                ...
                                onClick={() => context.dispatch(MANUAL_MATCH({ eventId, project: suggestedProject }))}
                            ></a>
                        )
                    }} />
            </p>
