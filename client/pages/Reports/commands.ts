 ...
 */
export const selectQuery = (selectedQuery: IReportsQuery, setQuery: React.Dispatch<React.SetStateAction<IReportsQuery>>, t: TFunction) => {
 ...
 * @param {TFunction} t Translate function
 */
export const selectGroupBy = (selectedGroupBy: IListGroups, setGroupBy: React.Dispatch<React.SetStateAction<IListGroups>>, t: TFunction) => {
