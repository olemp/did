[did-client - v0.9.10](../README.md) / [Components](../modules/components.md) / IEventListProps
...
- [ariaLabel](components.ieventlistprops.md#arialabel)
- [ariaLabelForGrid](components.ieventlistprops.md#arialabelforgrid)
- [ariaLabelForListHeader](components.ieventlistprops.md#arialabelforlistheader)
- [ariaLabelForSelectAllCheckbox](components.ieventlistprops.md#arialabelforselectallcheckbox)
- [ariaLabelForSelectionColumn](components.ieventlistprops.md#arialabelforselectioncolumn)
- [ariaLabelForShimmer](components.ieventlistprops.md#arialabelforshimmer)
- [cellStyleProps](components.ieventlistprops.md#cellstyleprops)
- [checkButtonAriaLabel](components.ieventlistprops.md#checkbuttonarialabel)
- [checkboxCellClassName](components.ieventlistprops.md#checkboxcellclassname)
- [checkboxVisibility](components.ieventlistprops.md#checkboxvisibility)
- [className](components.ieventlistprops.md#classname)
- [columnReorderOptions](components.ieventlistprops.md#columnreorderoptions)
...
- [compact](components.ieventlistprops.md#compact)
- [componentRef](components.ieventlistprops.md#componentref)
- [constrainMode](components.ieventlistprops.md#constrainmode)
- [dateFormat](components.ieventlistprops.md#dateformat)
- [detailsListStyles](components.ieventlistprops.md#detailsliststyles)
- [disableSelectionZone](components.ieventlistprops.md#disableselectionzone)
- [dragDropEvents](components.ieventlistprops.md#dragdropevents)
- [enableShimmer](components.ieventlistprops.md#enableshimmer)
- [enableUpdateAnimations](components.ieventlistprops.md#enableupdateanimations)
- [enterModalSelectionOnTouch](components.ieventlistprops.md#entermodalselectionontouch)
- [fadeIn](components.ieventlistprops.md#fadein)
- [filters](components.ieventlistprops.md#filters)
- [getCellValueKey](components.ieventlistprops.md#getcellvaluekey)
- [getGroupHeight](components.ieventlistprops.md#getgroupheight)
- [getKey](components.ieventlistprops.md#getkey)
- [getRowAriaDescribedBy](components.ieventlistprops.md#getrowariadescribedby)
- [getRowAriaLabel](components.ieventlistprops.md#getrowarialabel)
- [groupProps](components.ieventlistprops.md#groupprops)
...
- [indentWidth](components.ieventlistprops.md#indentwidth)
- [initialFocusedIndex](components.ieventlistprops.md#initialfocusedindex)
- [isHeaderVisible](components.ieventlistprops.md#isheadervisible)
- [isPlaceholderData](components.ieventlistprops.md#isplaceholderdata)
- [items](components.ieventlistprops.md#items)
- [layoutMode](components.ieventlistprops.md#layoutmode)
...
- [listProps](components.ieventlistprops.md#listprops)
- [minimumPixelsForDrag](components.ieventlistprops.md#minimumpixelsfordrag)
- [onActiveItemChanged](components.ieventlistprops.md#onactiveitemchanged)
- [onColumnHeaderClick](components.ieventlistprops.md#oncolumnheaderclick)
- [onColumnHeaderContextMenu](components.ieventlistprops.md#oncolumnheadercontextmenu)
- [onColumnResize](components.ieventlistprops.md#oncolumnresize)
- [onDidUpdate](components.ieventlistprops.md#ondidupdate)
- [onItemContextMenu](components.ieventlistprops.md#onitemcontextmenu)
- [onItemInvoked](components.ieventlistprops.md#oniteminvoked)
- [onRenderCheckbox](components.ieventlistprops.md#onrendercheckbox)
- [onRenderColumnHeader](components.ieventlistprops.md#onrendercolumnheader)
- [onRenderCustomPlaceholder](components.ieventlistprops.md#onrendercustomplaceholder)
- [onRenderDetailsFooter](components.ieventlistprops.md#onrenderdetailsfooter)
- [onRenderDetailsHeader](components.ieventlistprops.md#onrenderdetailsheader)
- [onRenderItemColumn](components.ieventlistprops.md#onrenderitemcolumn)
- [onRenderMissingItem](components.ieventlistprops.md#onrendermissingitem)
- [onRenderRow](components.ieventlistprops.md#onrenderrow)
- [onRowDidMount](components.ieventlistprops.md#onrowdidmount)
- [onRowWillUnmount](components.ieventlistprops.md#onrowwillunmount)
- [onShouldVirtualize](components.ieventlistprops.md#onshouldvirtualize)
- [removeFadingOverlay](components.ieventlistprops.md#removefadingoverlay)
- [resizableColumns](components.ieventlistprops.md#resizablecolumns)
- [rowElementEventMap](components.ieventlistprops.md#rowelementeventmap)
- [searchBox](components.ieventlistprops.md#searchbox)
- [selection](components.ieventlistprops.md#selection)
- [selectionMode](components.ieventlistprops.md#selectionmode)
- [selectionPreservedOnEmptyClick](components.ieventlistprops.md#selectionpreservedonemptyclick)
- [selectionProps](components.ieventlistprops.md#selectionprops)
- [selectionZoneProps](components.ieventlistprops.md#selectionzoneprops)
- [setKey](components.ieventlistprops.md#setkey)
- [shimmerLines](components.ieventlistprops.md#shimmerlines)
- [shimmerOverlayStyles](components.ieventlistprops.md#shimmeroverlaystyles)
- [shouldApplyApplicationRole](components.ieventlistprops.md#shouldapplyapplicationrole)
- [showEmptyDays](components.ieventlistprops.md#showemptydays)
- [skipViewportMeasures](components.ieventlistprops.md#skipviewportmeasures)
- [styles](components.ieventlistprops.md#styles)
- [theme](components.ieventlistprops.md#theme)
- [useFastIcons](components.ieventlistprops.md#usefasticons)
- [usePageCache](components.ieventlistprops.md#usepagecache)
- [useReducedRowRenderer](components.ieventlistprops.md#usereducedrowrenderer)
- [viewport](components.ieventlistprops.md#viewport)
