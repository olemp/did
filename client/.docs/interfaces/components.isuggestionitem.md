[did-client - v0.11.4](../README.md) / [Components](../modules/components.md) / ISuggestionItem
...
Defined in: [client/components/Autocomplete/SuggestionItem/types.ts:8](https://github.com/Puzzlepart/did/blob/dev/client/components/Autocomplete/SuggestionItem/types.ts#L8)
