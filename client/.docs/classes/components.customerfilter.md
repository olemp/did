[did-client - v0.12.0](../README.md) / [Components](../modules/components.md) / CustomerFilter
...
- [fromColumn](components.customerfilter.md#fromcolumn)
...
Defined in: [components/FilterPanel/Filters/CustomerFilter.ts:10](https://github.com/Puzzlepart/did/blob/dev/client/components/FilterPanel/Filters/CustomerFilter.ts#L10)
...
▸ **fromColumn**(`column`: IColumn): [*CustomerFilter*](components.customerfilter.md)
...
Defined in: [components/FilterPanel/Filters/CustomerFilter.ts:27](https://github.com/Puzzlepart/did/blob/dev/client/components/FilterPanel/Filters/CustomerFilter.ts#L27)
